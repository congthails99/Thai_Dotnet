...
<form id="formData" method="post" role="form" novalidate="novalidate">
    <div class="g-recaptcha" data-sitekey="6Lf6q74ZAAAAAKkVkPGP3hbqP3KiUYfC7SzrUcVu" data-secretkey="6Lf6q74ZAAAAALmDM5qMSaKeTSd38_9bGv6Fnz_z">
        <div class="container hnue_form">
            ...
            <div class="row" id="table1">
                ...
                <div class="col-3 form-group">
                    ...
                    <asp:TextBox class="form-control datepicker" autocomplete="off" ID="Ngaysinh" name="NgaySinh" type="text" value="" runat="server"></asp:TextBox>
                </div>
                <div class="col-3 form-group">
                ...
                <div class="col-3 form-group">
                    <asp:Button runat="server" ID="bt_Layma" Text="Lấy mã hồ sơ" class="btn btn-primary" OnClick="laymahoso_Click" />
                    &ensp;
                <asp:Button ID="bt_Update" Visible="false" class="btn btn-primary" runat="server" OnClick="Update_Click" Text="Cập nhật" />
                    &ensp;
