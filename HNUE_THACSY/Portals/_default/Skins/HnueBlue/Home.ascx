...
<div class='maincontent-1'>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                    <div id="Center_1" runat="server"></div>
            </div>
            <div class="col-md-4">
                <div id="Center_2" runat="server"></div>
            </div>
            <div class="col-md-4">
                    <div id="Center_3" runat="server"></div>
            </div>
        </div>
    </div>
</div>
<div class='maincontent-2'>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div id="Content_1" runat="server"></div>
            </div>
            <div class="col-md-4">
                    <div id="Content_2" runat="server"></div>
            </div>
            <div class="col-md-4">
                <div id="Content_3" runat="server"></div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
        		...
        		<p>Trang tuyển sinh Đại học Sư phạm Hà Nội</p>
            </div>
            <div class="col-md-5">
            	<h5>Liên hệ</h5>
                <p>Địa chỉ: Tầng 5 nhà Hiệu Bộ - 136 Xuân Thuỷ - Cầu Giấy - Hà Nội</p>
                <p>Điện thoại: 0961009434</p>
